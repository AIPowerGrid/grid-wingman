  ...
  return (
    <ReactTextareaAutosize
      ...
      className={cn(
        ...
        "flex w-full rounded-md border border-input bg-background px-3 py-1 text-sm ring-offset-background",
        ...
        "resize-none",
        "rounded-2xl",
        "border-foreground", // Specific border color
        "text-foreground",
        "text-sm",
        "font-semibold",
        "px-3", // Specific padding
        "py-1", // Specific padding
